            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <form class="card-body box-body bg-dark"   style="display: none;"  role="form" method="POST" action="{{route('super.tag.store')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tag_name" placeholder="Enter ...">
                                        </div>
                                        <!-- /.form-group -->
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form class="card-body"  role="form" method="POST" action="{{route('super.tag.updatesave',$item->id)}}" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class=" ">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>Tag Name*</label>
                                                                        <input type="text" class="form-control" name="tag_name" placeholder="Enter ..."  value="{{$item->name}}">
                                                                    </div>
                                                                    <!-- /.form-group -->
