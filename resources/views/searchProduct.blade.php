                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <a href="{{route('product',$product->slug)}}">
                                            <img src="{{asset('/productImage/'.$product->image1)}}" alt="">
                                        </a>
                                        @php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="product-pic-zoom">
                                                                <img class="product-big-img" src="{{asset('/productImage/'.$item->image1)}}" alt="">
                                                                <div class="zoom-icon">
                                                            ...
                                                            <div class="product-thumbs">
                                                                <div class="product-thumbs-track ps-slider owl-carousel">
                                                                    ...
                                                                    <div class="pt" data-imgbigurl="{{asset('/productImage/'.$item->image2)}}"><img
                                                                            src="{{asset('/productImage/'.$item->image2)}}" alt=""></div>
                                                                    <div class="pt" data-imgbigurl="{{asset('/productImage/'.$item->image3)}}"><img
                                                                            src="{{asset('/productImage/'.$item->image3)}}" alt=""></div>
                                                                    <div class="pt" data-imgbigurl="{{asset('/productImage/'.$item->image4)}}"><img
                                                                            src="{{asset('/productImage/'.$item->image4)}}" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
